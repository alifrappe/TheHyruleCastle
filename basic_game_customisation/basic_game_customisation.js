...
exports.insaneMode = exports.difficultMode = exports.difficultyType = exports.printTitleScreen = void 0;
var lib_1 = require("../base_game/lib");
// fonction qui démarre le jeu avec title screen
function printTitleScreen() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lib_1.figlet.text("Welcome to\nThe hyrule Castle", function (err, welcomeMessage) {
                        if (err) {
                            console.log("Error with screen title");
                            console.dir(err);
                            return;
                        }
                        console.log(lib_1.colors.green(welcomeMessage));
                        console.log("\n");
                    })];
                case 1:
                    _a.sent();
